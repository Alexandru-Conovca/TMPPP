"""
Console interface for Smart Home system.
Use this for testing without GUI.
        ...
        if choice == "1":
            ...
            if sub_choice == "1":
                ...
                if scenario:
                    ...
                    print(f"✓ {cloned_scenario.summary()}")
            else:
...
def run_console() -> None:
    """Compatibility wrapper used by the main launcher."""
    main()
